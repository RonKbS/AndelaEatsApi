...
class OrderRepo(BaseRepo):
    ...
    def create_order(self, user_id, date_booked_for, meal_items, channel='web'):
        order = Order(user_id=user_id, date_booked_for=datetime.strptime(date_booked_for, '%Y-%m-%d'), date_booked=datetime.now(), channel=channel)
