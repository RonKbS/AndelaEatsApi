...
Revision ID: ed0aa865a31c
Revises: 
Create Date: 2019-09-16 17:34:27.516311
...
def upgrade():
    ...
    op.create_index('meal_service_idx', 'meal_service', ['user_id', 'location_id', 'meal_vendor_engagement_id'], unique=False)
    ...
    op.create_index('order_idx', 'order', ['user_id', 'meal_vendor_engagement_id', 'location_id', 'status'], unique=False)
